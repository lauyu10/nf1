...
<html lang="en">
	<head>
		<title>NF1 Results Nascar Cup Series</title>
		<!-- Required meta tags -->
		<meta charset="utf-8">
	...
	<body>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-4 py-4">
							...
							<ul class="list-unstyled">
								<li><a href="index.php?control=routing_page&action=news_f1" class="text-white">Home</a></li>
		...
		<main role="main">
			...
			<section class="jumbotron text-center">
				<div class="container">
					<h1 class="jumbotron-heading">Results Nascar Cup Series</h1>
				</div>
			</section>
			...
			<div class="container">
				...
				{ ?>
					<form action="index.php?control=routing_page&action=results_loading_circuits" method="post">
