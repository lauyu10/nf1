...
<html lang="en">
	<head>
		<title>NF1 Team Information</title>
		<!-- Required meta tags -->
		<meta charset="utf-8">
	...
	<body>
		...
		<main role="main">
			...
			<section class="jumbotron text-center">
				<div class="container">
					<h1 class="jumbotron-heading">Team Information : <?php echo($team_info['nameTeam']) ?> </h1>
				</div>
			</section>
			...
			<div class="container">
				<div class="card text-center">
				  ...
				  <div class="card-block">
						...
						{ ?>
							<p class="card-text">Driver : <a href="index.php?control=routing_page&action=driver_page&driver=<?php echo($driver['idPilot']) ?>"><?php echo($driver['pilotNumber']) ?> / <?php echo($driver['namePilot']) ?></a></p>
			<?php	} ?>
				  </div>
				</div>
				<h1 class="jumbotron-heading"> Results of the team</h1>
				<table class="table">
					<thead>
						<tr>
					...
					<tbody>
						<?php foreach($team_race as $race)
						{ ?>
							<tr>
								<th><?php echo($race['year']) ?></th>
								<th><a href="index.php?control=routing_page&action=driver_page&driver=<?php echo($driver['idPilot']) ?>"><?php echo($race['namePilot']) ?></a></th>
								<th><?php echo($race['pilotNumber']) ?></th>
