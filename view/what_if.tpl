	...
	<body>
		...
		<main role="main">
			...
			<section class="jumbotron text-center">
				<img class="float-image-center" src="./view/images/what_if.jpg">
				<div class="container">

					<h1 class="jumbotron-heading">What If...</h1>
				</div>
			</section>
							...
							if($table_articles != null)
							{
								...
								{?>
									<div class="element">
										...
										<a href="index.php?control=routing_page&action=article_page&article=<?php echo($article['nameFile']);?>" class="text-black"><h1 class="title-page-menu"> <?php echo($article['title']);?></h1></a>
									</div>
								<?php
								}
							}
